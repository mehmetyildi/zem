	    		...
	    		<div class="col-md-3" id="{{ $image->id }}">
                    <div class="ibox">
                        <div class="ibox-content product-box">
                            <a href="{{ url('storage/uncut_'.$image->main_image) }}" title="{{ $image->caption_tr }}" data-gallery>
                            ...
                            <div class="product-desc">
                                ...
                                <a href="{{ route('cms.'.$pageUrl.'.gallery.edit', ['record' => $image->id]) }}" class="product-name"> {{ ($image->caption_tr) ?: 'Başlık Yok' }}</a>
