...
@component('cms.components.breadcrumb') 
	...
	<li><a href="{{ route('cms.'.$pageUrl.'.edit', ['record' => $record->project_id]) }}">{{ $record->project->title_tr }}</a></li>
@endcomponent
   	...
   	<div class="row">
   		{!! Form::model($record, ['route' => ['cms.'.$pageUrl.'.gallery.update', $record->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
		    ...
		    <div class="col-lg-1 formActions">
		    	<a href="{{ route('cms.'.$pageUrl.'.gallery', ['record' => $record->project_id]) }}" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Geri</a>
