			...
			<div class="col-lg-6">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						@include('cms.includes.crop-image-area', ['title' => 'Görsel (1173*827)', 'field' => 'main_image', 'ratio' => '1.42', 'required' => false])
					</div>
				</div>
				<div class="ibox float-e-margins">
					<div class="ibox-title">
					...
					<div class="ibox-content">
						...
						<hr>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="openInNewTab">Yeni Sekmede Aç?</label>
							<div class="col-sm-9">
								<input type="checkbox" name="openInNewTab" class="js-switch js-switch2" {{ $record->openInNewTab ? 'checked' : '' }}/>
							</div>
						</div>
					</div>
				</div>
