                    ...
                    <div id="currentTaskList">
	                    <ul class="sortable-list connectList agile-list" id="sort-list">
	                        ...
	                        <li class="warning-element" id="{{ $record->id }}">
	                            ...
	                            <span class="currentTaskDescription"><a href="{{ asset('storage/'.$record->main_image) }}" data-gallery><img src="{{ asset('storage/'.$record->main_image) }}" width="100"></a><br><br>{{ $record->title_tr }}</span>
