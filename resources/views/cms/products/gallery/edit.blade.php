...
@component('cms.components.breadcrumb') 
	...
	<li><a href="{{ route('cms.'.$pageUrl.'.edit', ['record' => $record->product_id]) }}">{{ $record->product->title_tr }}</a></li>
@endcomponent
   	...
   	<div class="row">
   		{!! Form::model($record, ['route' => ['cms.'.$pageUrl.'.gallery.update', $record->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
		    ...
		    <div class="col-lg-1 formActions">
		    	<a href="{{ route('cms.'.$pageUrl.'.gallery', ['record' => $record->product_id]) }}" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Geri</a>
											...
											<div class="col-sm-9">
												...
												<div class="tab-content">
													<div id="tab-caption_tr" class="tab-pane active">
														{!! Form::text('caption_tr', null, ['class' => 'form-control']) !!}
													</div>
