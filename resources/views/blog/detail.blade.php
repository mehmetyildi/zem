                ...
                <div class="container">
                        ...
                        <div class="col-md-12 project-banner-bg-color">
                            <div class="row">
                                ...
                                <div class="col-md-5 banner-text">
                                    <h1 class="">{{$theBlogPost->{'title_'.$l} }}</h1>

                                    <p>{{$theBlogPost->{'caption_'.$l} }}</p>
                                </div>
                                <div class="col-md-5 text-center py-4">

                                    <img src="{{ asset('storage/'.$theBlogPost->main_image) }}" alt="{{ $theBlogPost->{'title_'.$l} }}" title="{{ $theBlogPost->{'title_'.$l} }}" class="w-100">
                                </div>
                    ...
                    <div class="row bg-white py-5 justify-content-center">
                        <div class="col-md-12 ">
                            ...
                            <div class="line-centered"><span><p class="mb-0">{{$theBlogPost->created_at->format('d.m.Y')}}</p></span></div>
                        </div>
                        <div class="col-md-10 mt-4 ">
                            {!! $theBlogPost -> {'description_'.$l} !!}
                        </div>
                    </div>
                </div>
            </section>
