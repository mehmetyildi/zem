...
use App\Models\Customer as PageModel;
...
class CustomersController extends BaseController
{
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'customers';
        $this->pageName = 'Müşteriler';
        $this->pageItem = 'Müşteri';
    ...
    public function create()
    {
        ...
        $sectors = Sector::pluck('title_tr','id')->all();
        return view('cms.'.$this->pageUrl.'.create', compact('sectors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $record->save();
        $record->sectors()->sync($request->sector_list ?: []);
        SearchIndex::create([
    ...
    public function edit(PageModel $record)
    {
        checkPermissionFor('edit_content');
        $sectors = Sector::pluck('title_tr','id')->all();
        return view('cms.'.$this->pageUrl.'.edit', compact('record', 'sectors'));
    }
    ...
    public function delete(PageModel $record)
    {
        ...
        if($record->references()->count()){
            session()->flash('danger', 'Bu müşteriye bağlı referanslar var.');
