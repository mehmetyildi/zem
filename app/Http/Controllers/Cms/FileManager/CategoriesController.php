...
class CategoriesController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, FileManagerCategory::$rules,FileManagerCategory::messages());
    ...
    public function update(Request $request, PageModel $record)
    {
        ...
        $this->validate($request, FileManagerCategory::$updaterules,FileManagerCategory::messages());
