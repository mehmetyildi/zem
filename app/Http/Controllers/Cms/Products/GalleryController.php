...
use App\Models\Products\Product as ParentModel;
use App\Models\Products\ProductImage as PageModel;
use View;
use File;
...
class GalleryController extends BaseController
{
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'products';
        $this->pageName = 'Ürünler';
        $this->pageItem = 'Ürün Görseli';
        $this->urlColumn = 'caption_tr';
        $this->parentKey = 'product_id';
        $this->hasUrl = true;
