...
use App\Models\Projects\Project as PageModel;
...
class ProjectsController extends BaseController
{
    ...
    public function create()
    {
        ...
        $products = Product::pluck('title_tr','id')->all();
        $types = ProjectType::all();
        return view('cms.'.$this->pageUrl.'.create', compact( 'cities', 'customers', 'products', 'types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $record->save();
        $record->products()->sync($request->product_list ?: []);
        SearchIndex::create([
    ...
    public function edit(PageModel $record)
    {
        ...
        $products = Product::pluck('title_tr','id')->all();
        $types = ProjectType::all();
        return view('cms.'.$this->pageUrl.'.edit', compact('record', 'cities', 'customers', 'products', 'types'));
    }
    ...
    public function delete(PageModel $record)
    {
        ...
        if($record->references()->count()){
            session()->flash('danger', 'Bu projeye bağlı referanslar var.');
