...
namespace App\Http\Controllers\Cms\Employees;

use Illuminate\Http\Request;
use App\Http\Controllers\Cms\BaseController;
use App\Models\Employee as PageModel;
...
class EmployeesController extends BaseController
{
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'employees';
        $this->pageName = 'Çalışanlar';
        $this->pageItem = 'Çalışan';
        $this->urlColumn = 'name';
        $this->hasUrl = false;
    ...
    {
        checkPermissionFor('create_content',PageModel::messages());
