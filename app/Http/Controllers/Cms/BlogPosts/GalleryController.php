...
namespace App\Http\Controllers\Cms\BlogPosts;

use Illuminate\Http\Request;
use App\Http\Controllers\Cms\BaseController;
use App\Models\BlogPosts\BlogPost as ParentModel;
use App\Models\BlogPosts\BlogPostImage as PageModel;
use View;
use File;
