...
namespace App\Http\Controllers\Cms\ProjectTypes;

use Illuminate\Http\Request;
use App\Http\Controllers\Cms\BaseController;
use App\Models\Projects\ProjectType as PageModel;
...
class ProjectTypesController extends BaseController
{
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'project-types';
        $this->pageName = 'Proje Tipleri';
        $this->pageItem = 'Proje Tipi';
    ...
    public function delete(PageModel $record)
    {
        ...
        if($record->projects->count()){
            session()->flash('danger', 'Bu kategoriye bağlı projeler var.');
