...
namespace App\Http\Controllers\Cms\References;

use App\Models\Customer;
use App\Models\Projects\Project;
use Illuminate\Http\Request;
use App\Http\Controllers\Cms\BaseController;
use App\Models\Reference as PageModel;
...
{
    /**
     * ReferencesController constructor.
     * @param PageModel $model
     */
    public function __construct(PageModel $model)
    {
        $this->middleware('auth');
        $this->pageUrl = 'references';
        $this->pageName = 'Referanslar';
        $this->pageItem = 'Referans';
        $this->urlColumn = 'customer_id';
        $this->hasUrl = false;
    ...
    public function create()
    {
        ...
        return view('cms.'.$this->pageUrl.'.create', compact('projects', 'customers'));
    }
    ...
    public function edit(PageModel $record)
    {
        ...
        $projects = Project::all();
        $customers = Customer::all();
        return view('cms.'.$this->pageUrl.'.edit', compact('record', 'projects', 'customers'));
    }
