                    ...
                    success: function (data) {
                        ...
                        if (data && !data.error) {
						  ...
						  $('.send_message_form textarea').val("");
							...
							// Hide form 
                            /*$('.send_message_form .fields').addClass('invisible');
                            $('.send_message_form .fields.no-border').removeClass('invisible');
                            $('.send_message_form label').addClass('invisible');
                            $('.send_message_form input').addClass('invisible');
                            $('.send_message_form textarea').addClass('invisible');*/
